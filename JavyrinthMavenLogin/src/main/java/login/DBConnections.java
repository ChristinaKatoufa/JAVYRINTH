...
//H KLASH POU EXEI TA PANTA GIA TIN VASI DEDOMENWN KAI THN METHODO GIA TIN ENALLAGI TWN SCREENS
public class DBConnections {
    //METHODOS POU ALLAZEI TA SCREENS MESA APO TIS STATIC METHODOUS TWN FXML
    //DILADI MESA APO TA FXML ANAGNWRIZEI SE POIO WINDOW THELOUME NA PAME (AN THELEIS TO SUZITAME PARAPANW ENNOEITAI)
