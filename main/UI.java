...
public class UI {
	...
	public UI(GamePanel gamePanel) {
		...
		messageRectBorderColor = new Color(128, 133, 136, 220); // Old Silver #808588 https://www.color-name.com/hex/808588
		messageRectFillColor = new Color(223, 192, 38, 220); // Young Gold #DFC026 https://www.color-name.com/young-gold.color
	...
	public long getElapsedTime() {
		if(elapsedTime==0) elapsedTime = System.currentTimeMillis(); // Fix, if you exit game even when has not started(run) yet
		elapsedTime = System.currentTimeMillis() - elapsedTime;
		return elapsedTime;
	}
	...
	private void drawChronometer() {
		...
		g2.drawImage(image, 3*gamePanel.tileSize, 0, gamePanel.tileSize, gamePanel.tileSize, null);
		g2.setFont(chronometerFont);
		g2.setColor(Color.WHITE);
		g2.drawString(new DecimalFormat("00").format(minutes2display)+":"+new DecimalFormat("00").format(seconds2display), 4*gamePanel.tileSize+gamePanel.tileSize/2, gamePanel.tileSize-3);
	}
