...
public class TileManager {
	/**
	 *	isSolid Required for collision detection
	 *	labyrinth 2 D array holding number ids of map tiles
	 */
	public class Tile {
	...
	/**
	 * Every tile has it's image
	 * some tiles are solid, others aren't
	 */
	...
	/**
	 * Gets the file that has the labyrinth
	 * @param mapPath
	 * reads every col,row and fills the array
	 */
